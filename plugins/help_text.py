...
def help_user(bot, update):
    ...
    bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="⭕️ JOIN OUR CHANNEL ⭕️", url="https://t.me/mgbotslists")]]),
        parse_mode="html",
...
def send_start(bot, update):
    ...
    bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="⭕️ CHANNEL ⭕️", url="https://t.me/mgbotslists")], [InlineKeyboardButton(text="😇 SUPPORT", url="https://t.me/MG_Support_Group"),
